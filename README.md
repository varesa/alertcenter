...
This is a sample template for alertcenter - Below is a brief explanation of what we have generated for you:
...
aws cloudformation describe-stacks \
    --stack-name alertcenter --query 'Stacks[].Outputs'
```
